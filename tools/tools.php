...
class tools
{
    ...
    public static function getDomaine() {
        ...
        return (isset($_SERVER['HTTPS']) ? "https" : "http") . "://$_SERVER[HTTP_HOST]/API_REST_TELIYA/";
    }
    ...
    public static function getErrorCreatingdb(){
        $_RESPONSE['message'] = 'Une erreur est survenue lors de la creation de la base de données';
        $_RESPONSE['status'] = true;
        $_RESPONSE['donnes'] = null;
        return $_RESPONSE;
    }
    ...
    public static function getMessageErrorToken(array $response){
        $_RESPONSE['donnees'] = $response;
        $_RESPONSE['message'] = '01 élement(s) trouvé(s) dans le système';
        $_RESPONSE['status'] = false;
        return $_RESPONSE;
...
$_REQUEST_BDENAME = isset($_REQUEST['bd_name']) ? $_REQUEST['bd_name'] : null;
$_REQUEST_METHOD = $_SERVER['REQUEST_METHOD'];
$_NEWID = $tools::generateGuid();

 // var_dump('1_ Tools.php',$_REQUEST_BDENAME);